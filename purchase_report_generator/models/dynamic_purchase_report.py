...
class DynamicPurchaseReport(models.Model):
    ...
    def get_filter_data(self, option):
        ...
        default_filters = {}
        filter_dict = {'report_type': record.report_type}
    ...
    def get_purchase_xlsx_report(self, data, response, report_data, dfr_data):
        ...
        heading = workbook.add_format({'align': 'center', 'bold': True, 'font_size': '10px', 'border': 2, 'border_color': 'black'})
        ...
        if filters.get('report_type') == 'report_by_order':
            sheet.merge_range('B5:D5', 'Report Type: ' + filters.get('report_type'), txt_l)
